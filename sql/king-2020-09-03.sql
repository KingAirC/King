...
--
-- Table structure for table `pass_subjects`
--

DROP TABLE IF EXISTS `pass_subjects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pass_subjects` (
  `id` varchar(45) NOT NULL COMMENT 'ID',
...
--
-- Dumping data for table `pass_subjects`
--

LOCK TABLES `pass_subjects` WRITE;
/*!40000 ALTER TABLE `pass_subjects` DISABLE KEYS */;
/*!40000 ALTER TABLE `pass_subjects` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-09-03 22:09:37
